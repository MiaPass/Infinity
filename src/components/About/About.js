          ...
          <div className="inner-content">
            ...
            <div id="topic1" className="topic">
              ...
              <p>
                ...
                unde, facilis voluptatum possimus fuga enim dolores consequatur
                quia voluptates ad numquam magni itaque, adipisci quas alias
                sunt asperiores quae magnam?
              </p>
              <p>
                <strong>
              ...
              <p>
                ...
                voluptatibus, ex ipsam, velit eum quis id reprehenderit officiis
                vel ratione debitis incidunt, ipsa reiciendis repudiandae quia
                possimus? Amet earum, iure molestiae laborum consectetur totam
                aliquam laudantium quae modi neque placeat consequatur est et
                nam, officiis asperiores perferendis ipsa distinctio maiores?
                Eum, nam? Laudantium vel earum tempore inventore nam voluptates
                sapiente natus, explicabo magni necessitatibus fugiat expedita
                corrupti iste eum voluptatum dolore laborum nihil id atque
                adipisci cum harum. Beatae, obcaecati.
              </p>
            </div>
            {/*topic 2*/}
                ...
                <div className="table">
                  <div>
                    {payType !== "Mercado Pago" ? (
                      <button
                        className="title"
                        onClick={(e) => handleClick(e, "Mercado Pago")}
                      >
                        Mercado Pago
                      </button>
                    ) : (
